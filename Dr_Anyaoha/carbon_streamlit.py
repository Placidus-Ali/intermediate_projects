...
df = pd.read_csv("C:/Users/STUTERN/Desktop/intermediate_projects/Dr_Anyaoha/emission_factor_clean.csv")
print("Dataset Loaded Successfully")

def format_activity_name(activity):
    activity_mappings = {
        "Domestic_flightÂ": "How many KM of Domestic Flights taken per year",
        "International_flight": "How many KM of International Flights taken per year",
...
print("Name and Gender Created Successfully")

# Check if name and gender are entered
if not name or not gender:
    st.warning("Please enter your name and select your gender before proceeding.")
else:
    # Display message based on name 
    st.write(f"Welcome {name}! Let's calculate your carbon emissions.")
